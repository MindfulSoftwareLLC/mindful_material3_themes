...
class MindfulFlutterThemes {
  ...
  static Map<String, MindfulTheme> themes = {
    'Green': const MindfulTheme(
      'Green',
      lightColorSchemeForestGreen,
      darkColorSchemeForestGreen,
    ),
    'Maroon': const MindfulTheme(
        'Maroon', lightColorScheme99405E, darkColorScheme99405E),
    'Red': const MindfulTheme(
        'Red', lightColorSchemeA53750, darkColorSchemeA53750),
    'Hot Pink': const MindfulTheme(
